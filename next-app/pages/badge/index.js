...
export default function Certificate() {
  const trackIds = getKoanIdsByTrack('standard');
  const trackStats = getTrackStats('standard');
  ...
  const shareText = `🎉 I just completed all ${trackIds.length} PySpark Fundamentals Koans! Master your PySpark skills through interactive exercises. #PySpark #DataEngineering #Learning`;
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Completed all ${trackIds.length} PySpark Fundamentals Koans - Master PySpark through interactive exercises`} />

        {/* Open Graph meta tags for social sharing */}
        <meta property="og:title" content="Completed all PySpark Koans!" />
        <meta property="og:description" content={`Successfully completed all ${trackIds.length} PySpark Fundamentals exercises. Master your data engineering skills!`} />
        ...
        <meta name="twitter:description" content={`Successfully completed all ${trackIds.length} PySpark Fundamentals exercises.`} />
        ...
        {!isFullyComplete ? (
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-400 mb-4">
              You&apos;ve completed {trackProgress} out of {trackIds.length} Fundamentals koans.
            </p>
