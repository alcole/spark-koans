...
assert DeltaTable.isDeltaTable(spark, "/data/products"), "Table should exist"
print("✓ Table 'products' created")

# Get the table and verify schema
dt = DeltaTable.forPath(spark, "/data/products")
df = dt.toDF()
...
print("\\n🎉 Koan complete! You've learned the DeltaTable builder.")`,
    solution: `DeltaTable.create(spark).location("/data/products").addColumn("id", "INT").addColumn("name", "STRING").addColumn("price", "DOUBLE").execute()`,
    hints: [
