...
const KOANS = [
  {
    ...
    setup: `data = [("Alice", 34), ("Bob", 45), ("Charlie", 29)]
columns = ["name", "age"]`,
...
print("\\n🎉 Koan complete! You've learned to create a DataFrame.")`,
  ...
  },
  {
    ...
    setup: `data = [("Alice", 34, "NYC"), ("Bob", 45, "LA"), ("Charlie", 29, "Chicago")]
...
assert "name" in result.columns and "city" in result.columns
print("✓ Correct columns selected")

print("\\n🎉 Koan complete! You've learned to select columns.")`,
    solution: 'result = df.select("name", "city")',
    hints: ["Think about what action you want: you want to 'select' columns", "The method takes column names as strings"]
  },
  {
    id: 3,
    ...
    setup: `data = [("Alice", 34), ("Bob", 45), ("Charlie", 29), ("Diana", 52)]
...
print("\\n🎉 Koan complete! You've learned to filter rows.")`,
    ...
    hints: ["You want to 'filter' the DataFrame", "Use > for greater than"]
  },
  {
    id: 4,
    title: "Adding Columns",
    category: "Basics",
    description: "Add a new calculated column to a DataFrame.",
    setup: `data = [("Alice", 34), ("Bob", 45), ("Charlie", 29)]
df = spark.createDataFrame(data, ["name", "age"])`,
...
print("\\n🎉 Koan complete! You've learned to add columns.")`,
    ...
    hints: ["The method name suggests adding 'with' a new 'Column'", "Reference the 'age' column to multiply it"]
  },
  {
    id: 5,
...
print("\\n🎉 Koan complete! You've learned to group and aggregate.")`,
    ...
    hints: ["First you need to group the data using 'groupBy'", "Use 'avg' function for average"]
  },
  {
    id: 6,
    title: "Joining DataFrames",
    category: "Basics",
    description: "Join two DataFrames to combine related data.",
    setup: `employees = spark.createDataFrame([
    (1, "Alice", 101),
    (2, "Bob", 102),
    (3, "Charlie", 101)
], ["emp_id", "name", "dept_id"])
...
assert "name" in result.columns and "dept_name" in result.columns
...
print("\\n🎉 Koan complete! You've learned to join DataFrames.")`,
    ...
    hints: ["The method to combine DataFrames is called 'join'", "Specify the column to join on as a string"]
  },
  {
    id: 7,
...
df = spark.createDataFrame(data, ["date", "sales"])`,
    template: `# Create a window that orders by date for running total
...
print("\\n🎉 Koan complete! You've learned window functions.")`,
    ...
    hints: ["For a running total, you want up to 'currentRow'", "Use spark_sum to add up values"]
  },
  // ==================== DELTA LAKE ====================
  {
    id: 101,
    ...
    category: "Delta Lake",
    description: "Write a DataFrame as a Delta table and read it back.",
    setup: `_reset_delta_tables()
...
print("\\n🎉 Koan complete! You've created your first Delta table.")`,
    solution: 'df.write.format("delta").mode("overwrite").save("/data/employees")\nDeltaTable.isDeltaTable(spark, "/data/employees")',
    hints: ["Use .format() to specify 'delta'", "isDeltaTable() checks if a path is a Delta table"]
  },
  {
    id: 102,
    title: "Time Travel - Version",
    category: "Delta Lake",
    description: "Query a previous version of a Delta table.",
    setup: `_reset_delta_tables()
...
print("\\n🎉 Koan complete! You've mastered time travel queries.")`,
    ...
    hints: ["Use .option() for time travel", "The option is 'versionAsOf'"]
  },
  {
    id: 103,
    title: "MERGE - Upsert Pattern",
    category: "Delta Lake",
    description: "Use MERGE to update existing rows and insert new ones.",
    setup: `_reset_delta_tables()
...
source_data = [("Alice", 150), ("Charlie", 300)]
...
print("\\n🎉 Koan complete! You've mastered the MERGE upsert pattern.")`,
    ...
    hints: ["Start with .merge(source, condition)", "Use whenMatchedUpdateAll() and whenNotMatchedInsertAll()"]
  },
  {
    id: 104,
    title: "Table History",
    category: "Delta Lake",
    description: "View the history of operations on a Delta table.",
    setup: `_reset_delta_tables()
...
print("\\n🎉 Koan complete! You can now audit Delta table changes.")`,
    ...
    hints: ["The method to get history is simply .history()"]
  },
  {
    id: 105,
    title: "OPTIMIZE and Z-ORDER",
    category: "Delta Lake",
    description: "Optimize a Delta table for better query performance.",
    setup: `_reset_delta_tables()
...
print("\\n🎉 Koan complete! You've learned table optimization.")`,
    ...
    hints: ["Use .optimize() to compact files", "Chain .zorderBy() for co-locating related data"]
  },
  {
    id: 106,
    title: "Delete with Condition",
    category: "Delta Lake",
    description: "Delete rows from a Delta table based on a condition.",
    setup: `_reset_delta_tables()
...
print("\\n🎉 Koan complete! You've learned Delta delete operations.")`,
    ...
    hints: ["Use .delete() with a condition string"]
  },
  {
    id: 107,
    title: "Update with Condition",
    category: "Delta Lake",
    description: "Update rows in a Delta table based on a condition.",
    setup: `_reset_delta_tables()
...
# Give all premium users a bonus: set balance to 300
dt.___(
...
print("\\n🎉 Koan complete! You've learned Delta update operations.")`,
    ...
    hints: ["Use .update() with condition and set_values", "The column to update is 'balance'"]
  },
  {
    id: 108,
    title: "Create Table with Builder",
    category: "Delta Lake",
    description: "Create a Delta table with an explicit schema using the builder API.",
    setup: "_reset_delta_tables()",
...
print("\\n🎉 Koan complete! You've learned the DeltaTable builder.")`,
    ...
    hints: ["Use DeltaTable.create(spark) to start the builder", "The missing column name is 'name'"]
  },
  {
    id: 109,
    title: "VACUUM Old Files",
    category: "Delta Lake",
    description: "Clean up old files from a Delta table to save storage.",
    setup: `_reset_delta_tables()
...
# Vacuum to remove old files (default retention is 168 hours)
...
print("\\n🎉 Koan complete! You understand VACUUM and retention.")`,
    ...
    hints: ["Use .vacuum() to clean up old files", "retention_hours specifies how far back to keep"]
  },
  {
    id: 110,
    title: "MERGE - Delete Matched",
    category: "Delta Lake",
    description: "Use MERGE to delete rows that match a condition.",
    setup: `_reset_delta_tables()

target_data = [("Alice", "active"), ("Bob", "inactive"), ("Charlie", "active")]
target_df = spark.createDataFrame(target_data, ["name", "status"])
target_df.write.format("delta").save("/data/users")

deactivate_data = [("Bob",), ("Diana",)]
deactivate_df = spark.createDataFrame(deactivate_data, ["name"])`,
    template: `# Get the Delta table
dt = DeltaTable.forPath(spark, "/data/users")

# Merge to delete matched users
dt.merge(
    deactivate_df,
    "target.name = source.name"
).whenMatched___().execute()
...
assert "Alice" in names, "Alice should remain"
print("✓ Alice still present")

assert result.count() == 2, f"Expected 2 rows, got {result.count()}"
print("✓ Correct row count")

print("\\n🎉 Koan complete! You've learned MERGE with delete.")`,
    solution: 'dt.merge(deactivate_df, "target.name = source.name").whenMatchedDelete().execute()',
    hints: ["Use whenMatchedDelete() to remove matching rows"]
  }
];
...
class Column:
    ...
    def alias(self, name):
        ...
        new_col._alias = name
        for attr in ['_agg_func', '_source_col', '_round_decimals']:
    ...
    def over(self, window):
        ...
        for attr in ['_agg_func', '_source_col']:
            if hasattr(self, attr): setattr(new_col, attr, getattr(self, attr))
        return new_col
...
class DataFrame:
    ...
    def withColumn(self, name, col):
        ...
        if hasattr(col, '_is_window_func') and col._is_window_func:
            ...
            if window._order_cols:
                sort_cols = [c if isinstance(c, str) else c.name for c in window._order_cols]
    ...
    def orderBy(self, *cols):
        sort_cols = [c if isinstance(c, str) else c.name for c in cols]
        return DataFrame(self._pdf.sort_values(sort_cols).reset_index(drop=True))
...
class DataFrameReader:
    ...
    def load(self, path):
        if self._format == "delta" and path in _delta_tables:
            table_data = _delta_tables[path]
            if "versionAsOf" in self._options:
                return DataFrame(table_data.get_df(int(self._options["versionAsOf"])))
    ...
    def save(self, path):
        if self._format == "delta":
            ...
            if path in _delta_tables:
                ...
                _delta_tables[path] = DeltaTableData(path, pdf)
...
class MergeBuilder:
    ...
    def whenMatchedUpdate(self, set=None):
        b = MergeBuilder(self._delta_table, self._source_df, self._condition)
        b._when_matched_update = set or "ALL"
        b._when_not_matched_insert = self._when_not_matched_insert
        return b
    
    def whenMatchedUpdateAll(self): return self.whenMatchedUpdate("ALL")
    
    def whenMatchedDelete(self):
        b = MergeBuilder(self._delta_table, self._source_df, self._condition)
        b._when_matched_delete = True
        b._when_not_matched_insert = self._when_not_matched_insert
        return b
    
    def whenNotMatchedInsert(self, values=None):
        b = MergeBuilder(self._delta_table, self._source_df, self._condition)
        b._when_matched_update = self._when_matched_update
        b._when_matched_delete = self._when_matched_delete
        b._when_not_matched_insert = values or "ALL"
        return b
    
    def whenNotMatchedInsertAll(self): return self.whenNotMatchedInsert("ALL")
    ...
    def execute(self):
        ...
        for part in self._condition.replace("target.", "").replace("source.", "").split(" AND "):
            if "=" in part: key_cols.append(part.split("=")[0].strip())
        ...
        for idx, row in merged.iterrows():
            status = row['_merge']
            if status == 'both':
                if self._when_matched_delete: continue
                elif self._when_matched_update:
                    new_row = {}
                    for col in target_df.columns:
                        src_col = f"{col}_source"
                        new_row[col] = row[src_col] if src_col in row and pd.notna(row[src_col]) else row[col]
                    result_rows.append(new_row)
                else:
                    result_rows.append({col: row[col] for col in target_df.columns})
            elif status == 'left_only':
                result_rows.append({col: row[col] for col in target_df.columns})
            elif status == 'right_only' and self._when_not_matched_insert:
                new_row = {}
                for col in target_df.columns:
                    src_col = f"{col}_source"
                    new_row[col] = row[src_col] if src_col in row and pd.notna(row[src_col]) else row.get(col)
                result_rows.append(new_row)
...
class DeltaTableBuilder:
    ...
    def execute(self):
        ...
        _delta_tables[path] = DeltaTableData(path, initial_df)
...
class DeltaTable:
    ...
    def forPath(cls, spark, path):
        if path not in _delta_tables: raise ValueError(f"Table not found: {path}")
        return cls(_delta_tables[path])
    
    @classmethod
    def create(cls, spark): return DeltaTableBuilder(spark)
    
    @classmethod
    def isDeltaTable(cls, spark, path): return path in _delta_tables
    
    def toDF(self): return DataFrame(self._table_data.get_df())
    
    def merge(self, source, condition): return MergeBuilder(self, source, condition)
    ...
    def update(self, condition=None, set_values=None):
        ...
        self._table_data._add_version(df, "UPDATE")
    
    def delete(self, condition=None):
        df = self._table_data.get_df()
        if condition:
            df = df[~df.eval(condition)].reset_index(drop=True)
        else:
            df = pd.DataFrame(columns=df.columns)
        self._table_data._add_version(df, "DELETE")
    ...
    def optimize(self):
        df = self._table_data.get_df()
        self._table_data._add_version(df, "OPTIMIZE")
...
def round(col_expr, decimals=0):
    ...
    for attr in ['_agg_func', '_source_col', '_alias']:
        if hasattr(col_expr, attr): setattr(new_col, attr, getattr(col_expr, attr))
...
export default function PySparkKoans() {
  ...
  useEffect(() => {
    async function initPyodide() {
      ...
      try {
        ...
        await pyodideInstance.runPythonAsync(SHIM_CODE);
  ...
  const runCode = async () => {
    ...
    try {
      await pyodide.runPythonAsync(SHIM_CODE);
...
`);
      ...
      setOutput('Error:\n' + error.message + '\n\nTip: Check your syntax and replace all ___ placeholders.');
    }
    setIsRunning(false);
  };
  ...
  const nextHint = () => {
    setShowHints(true);
    if (currentHint < koan.hints.length - 1) setCurrentHint(prev => prev + 1);
  };
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      <div className="flex">
        <div className="w-72 min-h-screen bg-gray-900 border-r border-gray-800 p-4 overflow-y-auto">
          <h1 className="text-2xl font-bold text-orange-500 mb-1">Databricks Koans</h1>
          ...
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-800 rounded-full h-2">
              <div className="bg-orange-600 h-2 rounded-full transition-all" style={{ width: `${(completedKoans.size / KOANS.length) * 100}%` }} />
            </div>
          </div>
          ...
          <div className="mb-4">
            <button
              ...
              className={`w-full text-left px-3 py-2 rounded-lg text-sm mb-1 ${selectedCategory === null ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-gray-800'}`}
            >
            ...
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-lg text-sm mb-1 flex justify-between ${selectedCategory === cat ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-gray-800'}`}
              >
                <span>{cat}</span>
                <span className="text-xs opacity-75">{KOANS.filter(k => k.category === cat && completedKoans.has(KOANS.indexOf(k))).length}/{KOANS.filter(k => k.category === cat).length}</span>
              </button>
            ))}
          </div>
          ...
          <div className="space-y-1">
            {filteredKoans.map((k) => {
              const idx = KOANS.indexOf(k);
              return (
                <button
                  key={k.id}
                  onClick={() => setCurrentKoan(idx)}
                  className={`w-full text-left px-3 py-2 rounded-lg text-sm flex items-center gap-2 ${idx === currentKoan ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800/50'}`}
                >
                  <span className={`w-5 h-5 rounded flex items-center justify-center text-xs ${completedKoans.has(idx) ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-400'}`}>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-2">
                <span className={`text-xs px-2 py-1 rounded ${koan.category === 'Delta Lake' ? 'bg-blue-900 text-blue-300' : 'bg-gray-800 text-gray-400'}`}>
                  {koan.category}
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-900 rounded-lg border border-gray-800">
                  <div className="px-4 py-2 bg-gray-800 border-b border-gray-700 text-sm text-gray-400">Setup</div>
                  <pre className="p-4 text-sm text-gray-400 font-mono whitespace-pre-wrap">{koan.setup}</pre>
                </div>
                {showHints && (
                  <div className="bg-yellow-900/20 border border-yellow-800/50 rounded-lg p-4">
                    <h3 className="text-sm font-medium text-yellow-500 mb-2">Hint {currentHint + 1}/{koan.hints.length}</h3>
                ...
                {showSolution && (
                  <div className="bg-green-900/20 border border-green-800/50 rounded-lg p-4">
                    ...
                    <pre className="text-sm text-green-200/80 font-mono whitespace-pre-wrap">{koan.solution}</pre>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-900 rounded-lg border border-gray-800">
                  <div className="flex justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
                ...
                <div className="flex gap-2 flex-wrap">
                  <button onClick={runCode} disabled={isLoading || isRunning} className="px-4 py-2 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-700 rounded-lg font-medium">
                    {isLoading ? 'Loading...' : isRunning ? 'Running...' : 'Run Code'}
                  </button>
                  <button onClick={nextHint} disabled={currentHint >= koan.hints.length - 1 && showHints} className="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg">
                    {showHints ? 'Next Hint' : 'Hint'}
                  </button>
                  <button onClick={() => setShowSolution(!showSolution)} className="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg">
                    {showSolution ? 'Hide' : 'Solution'}
                  </button>
                  <button onClick={() => setCode(koan.template)} className="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg">Reset</button>
                </div>

                <div className="bg-gray-900 rounded-lg border border-gray-800">
                  <div className="px-4 py-2 bg-gray-800 border-b border-gray-700 text-sm text-gray-400">Output</div>
                  <pre className={`p-4 h-48 overflow-auto font-mono text-sm whitespace-pre-wrap ${output.includes('🎉') ? 'text-green-400' : output.includes('Error') ? 'text-red-400' : 'text-gray-300'}`}>
